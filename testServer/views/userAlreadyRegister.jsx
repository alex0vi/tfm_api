        ...
        <div style={ styles.container } >
            <div style={ styles.text }>
                <div style={ styles.primary }>
                    This email is already register in RealSafe!
                </div>
                <div style={ styles.secondary }>
                <br/>Go to the crowdsale <a style={ styles.contactUs } href="https://ico.realsafe.co/#/register">here</a> Or get your account back <a style={ styles.contactUs } href="https://realsafe.co">here</a>
                </div>
